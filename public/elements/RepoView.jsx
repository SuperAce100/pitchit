      ...
      <CardHeader className="bg-background border-b p-4">
        <div className="flex flex-col gap-4">
          <div className="flex items-center">
            <Book className="h-5 w-5 mr-2 text-gray-700" />
            <CardTitle className="text-xl font-semibold tracking-tight">
              <a href={props.repo_url} className="hover:underline text-blue-600" target="_blank" rel="noopener noreferrer">
                {props.repo_name}
              </a>
            </CardTitle>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="flex items-center">
              <GitFork className="h-4 w-4 mr-1 text-gray-600" />
              <span className="text-gray-700">0</span>
            </div>
            <div className="flex items-center">
      ...
      <Tabs defaultValue="readme" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-2 max-w-md">
          <TabsTrigger value="readme" className="text-sm">
            <Book className="h-4 w-4 mr-2" /> README
          </TabsTrigger>
        ...
        <CardContent className="p-0">
          <TabsContent value="readme" className="mt-0">
              <div className="prose p-6 max-w-none">
                {renderMarkdown(props.readme_content)}
              </div>
          </TabsContent>
